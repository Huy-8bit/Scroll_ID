...
async function main() {
  let oracleAddress = "0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419"; // contract mainnet of chainlink ETH USDT
  ...
  const priceOracle = await deploySMC("StablePriceOracle", [
    oracleAddress,
